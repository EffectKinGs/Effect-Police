...
class MDT(commands.Cog):
    ...
    async def mdt_panel(
        ...
        embed = utils.base_embed("MDT System", description, image_url="attachment://evil_town_banner.png")
        await utils.send_panel(interaction.channel, embed, MDTPanelView(), "evil_town_banner.png")
    ...
    async def record_check_panel(self, interaction: discord.Interaction):
        ...
        embed = utils.base_embed("Record Check", description, image_url="attachment://evil_town_banner.png")
        await utils.send_panel(interaction.channel, embed, RecordCheckPanelView(), "evil_town_banner.png")
        await utils.send_log(
