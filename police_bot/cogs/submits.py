"""لوحة التقديم على العسكرية (Submits) — EvilTown Police Department Application."""
...
class Submits(commands.Cog):
    ...
    async def submits_panel(self, interaction: discord.Interaction, review_channel: discord.TextChannel = None):
        ...
        description = (
            "**<:ETRP_28:1499883636110135476> - Welcome To The Evil Town Police Department Application "
            "Division, Where You Can Serve And Protect Your Nation While Leaving Your Mark Within Its Ranks .**"
        )
        embed = utils.base_embed("Submits", description, image_url="attachment://evil_town_banner.png")
        await utils.send_panel(interaction.channel, embed, SubmissionPanelView(), "evil_town_banner.png")
        await utils.send_log(
