"""إعدادات بوت Effect King's Police."""
...
# اسم الصورة الافتراضية لأي لوحة ما عدا لوحة الدخول (Login تستخدم LOGIN_BANNER_ASSET).
PANEL_BANNER_ASSET = "effect_panel_banner.png"
...
# اسم الصورة اللي يرسلها أمر "خ" (وتُرسل تلقائياً بقنوات LINE_IMAGE_AUTO_CHANNEL_IDS).
LINE_IMAGE_ASSET = "effect_line_image.png"

# إيموجي عنوان كل لوحة على حدة — عدّل القيمة هنا عشان تخصص أيقونة كل لوحة لحالها
# بدل ما تكون كل اللوحات على نفس الأيقونة الموحدة. المفتاح "default" لأي لوحة بدون مفتاح خاص.
PANEL_TITLE_EMOJIS = {
